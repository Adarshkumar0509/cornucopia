...
export class FileSystemHelper {
  ...
  public static ASVSRouteMap(version = "4.0.3"): Route[] {
    ...
    firstLevelDirs.forEach((firstLevelDir) => {
      ...
      const firstPart = (sectionRegex.exec(firstLevelDir))?.[1];
      ...
      secondLevelDirs.forEach((secondLevelDir) => {
        const secondPart = (sectionRegex.exec(secondLevelDir))?.[1];
  ...
  public static getDataByRoute(route: string, lang = 'en'): [string[], string] {
